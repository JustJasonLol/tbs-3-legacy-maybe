...
class ClientPrefs {
	...
	public static var cacheOnGPU = false;
	...
	inline public static function getGameplaySetting(name:String, defaultValue:Dynamic):Dynamic {
		return /*funkin.game.PlayState.isStoryMode ? defaultValue : */ (gameplaySettings.exists(name) ? gameplaySettings.get(name) : defaultValue);
	}

	public static function reloadControls() {
		PlayerSettings.player1.controls.setKeyboardScheme(KeyboardScheme.Solo);

		funkin.menus.TitleState.muteKeys = copyKey(keyBinds.get('volume_mute'));
		funkin.menus.TitleState.volumeDownKeys = copyKey(keyBinds.get('volume_down'));
		funkin.menus.TitleState.volumeUpKeys = copyKey(keyBinds.get('volume_up'));
