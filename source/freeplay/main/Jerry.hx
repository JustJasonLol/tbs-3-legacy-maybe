...
class Jerry extends MusicBeatState
{
	var CanSelect:Bool;
	...
	{	
		...
		image2 = new FlxSprite(841, 257).loadGraphic(Paths.image('freeplay/pictures/sirokou'));
		...
		song2 = new FlxSprite(150, 340).loadGraphic(Paths.image('freeplay/songs/sirokou'));
		song2.visible = false;
		add(song2);
