...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		else if(Data.week1Lock == "unlocked")
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "The Basement Show v" + Application.current.meta.get('version'), 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.BACK)
			{
				...
				MusicBeatState.switchState(new funkin.menus.TitleState());
			}
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									...
									case 'options':
										LoadingState.loadAndSwitchState(new funkin.menus.options.OptionsState());
								}
							});
						}
					});
