...
/**
 * pretty much a FreeplayState copy, nothing much to say
 */
class FreeplayCategory extends MusicBeatState
{
	var songs:Array<SongMetadata_> = [];
	...
	var bg:FlxSprite;
   @:notNull var banner:FlxSprite;
	@:isVar @:notNull var leText:FlxText;
	...
	override function create()
	{
		...
		#if PRELOAD_ALL
		var leText:String = "Press SPACE to listen to the instrumentañ / Press CTRL to open the Gameplay Changers Menu / Press RESET to Reset your Score and Accuracy.";
		var size:Int = 16;
		#else
		var leText:String = "Press CTRL to open the Gameplay Changers Menu / Press RESET to Reset your Score and Accuracy.";
		var size:Int = 18;
		#end
		var text:FlxText = new FlxText(textBG.x, textBG.y + 4, FlxG.width, '', size);
	...
	public function addCategory(songName:String, weekNum:Int, songCharacter:String, color:Int)
	{
		songs.push(new SongMetadata_(songName, weekNum, songCharacter, color));
	}
	...
	override function update(elapsed:Float)
	{
      ...
      banner.loadGraphic(Paths.image('freeplay/main_menu/$curSelected'));
		...
		else if (accepted)
		{
         ...
         {
            case 0:
               LoadingState.loadAndSwitchState(new funkin.freeplay.main.Jerry());
               trace('Category: Jerry week');
            case 1:
               LoadingState.loadAndSwitchState(new funkin.freeplay.main.Tom());
               trace('Category: Tom week');
            case 2:
               LoadingState.loadAndSwitchState(new funkin.freeplay.main.WhyDidYallAddPibbyGoddamn());
               trace('Category: Goofy ahh pibby shit week');
				case 3:
					LoadingState.loadAndSwitchState(new funkin.freeplay.ExtrasState());
               trace('Category: Massive extras');
				case 4:
					LoadingState.loadAndSwitchState(new FreeplayState('Covers'));
               trace('Category: funi covers');
         }
